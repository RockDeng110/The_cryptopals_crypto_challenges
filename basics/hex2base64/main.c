...
//    }
    ...
    int cmp_result;
    cmp_result = strcmp(output, base64);
    if (cmp_result == 0){
        printf("Converted string == Target string\n");
    } else{
        printf("Converted string != Target string\n");
    }
...
//        printf(" binary form(reverse order): ");
//        printf_binary(num);
//        printf("\n");
